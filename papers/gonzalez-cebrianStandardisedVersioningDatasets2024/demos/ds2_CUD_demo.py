...
# FRO: Corrected error in a typo in the mode_der 
...
__, vD_pca_de = av.versionDER(ds02_d_demo, ps_dict["PS_dic"]["PCA"]["E"], outdict=True, loadfile=False, dstitle="DS 02 deletion-demo pca-dE", drift_dist="dE", 
                                  cat_threshold = 2)
vD_ae_de = avae.versionDER(ds02_d_demo, ps_dict["PS_dic"]["AE"], "../results/ds02-demo/aelogs/tb_logs", "../results/ds02-demoxs", outdict=True, loadfile=False, 
...
# %%
demo_results = pd.DataFrame({"datasets": "ds02", 
...
print("Please find the generated numeric and graphic results in the folder: /scientificDataPaper/results/ds02-demo/")
