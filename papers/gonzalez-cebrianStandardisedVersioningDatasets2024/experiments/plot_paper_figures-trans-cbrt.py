"""
Script Name: plot_paper_figures-trans-cbrt.py
Description: this script is designed for the analysis and visualization of results related 
to the update events in the context of CUD experiments performed with each dataset. 
...
the first set illustrates data drift metrics ($d_{P}$, $d_{E, PCA}$, $d_{E, AE}$) over permutations
of the set of transformed colums, summarising the values by the mean, 5% and 95% percentiles; 
while the second set depicts the time required for the fitting process. The script utilizes 
custom line styles and colors to distinguish between the metrics and datasets, which are also 
provided manually and can be set by the user. The resulting visualizations are saved as a PDF 
file for further analysis and dissemination. 

Author:
- Name: Alba González-Cebrián, Fanny Rivera-Ortiz, Jorge Mario Cortés-Mendoza, Adriana E. Chis, 
    Michael Bradford, Horacio González-Vélez
...
dayresults = "2023-05-22"
resfolder = "2023-05-22"
...
file_paths = [
    "../results/ds01/fixed-ds-01-trcols-cbrt.xlsx",
    "../results/ds02/fixed-ds-02-trcols-cbrt.xlsx",
    "../results/ds03/fixed-ds-03-trcols-cbrt.xlsx",
    "../results/ds04/fixed-ds-04-trcols-cbrt.xlsx",
    "../results/ds05/fixed-ds-05-trcols-cbrt.xlsx",
    "../results/ds06/fixed-ds-06-trcols-cbrt.xlsx",
    "../results/ds07/fixed-ds-07-trcols-cbrt.xlsx"
]
...
fig.suptitle("Update events", fontsize=16)
...
plt.pause(0.1)
fig.savefig("../figures/update-datadrift-cbrt.pdf", dpi = 400, format="pdf")
# %%
# %%
# Create the figure and subplots
fig, axs = plt.subplots(2, 4, figsize=(12.5, 6))
...
# FRO: Added the following line to remove the need to press a key
#plt.pause(0.1)
fig.savefig("../figures/update-time-cbrt.pdf", dpi = 400, format="pdf")
# %%
