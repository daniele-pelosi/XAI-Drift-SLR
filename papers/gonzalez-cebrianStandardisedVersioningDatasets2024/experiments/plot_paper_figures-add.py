"""
Script Name: plot_paper_figures-add.py
...
fig.suptitle("Creation events", fontsize=16)
...
plt.pause(0.1)
fig.savefig("../figures/creation-datadrift.pdf", dpi = 400, format="pdf")
# %%
# Create the figure and subplots
fig, axs = plt.subplots(2, 4, figsize=(12.5, 6))
# Generate data for each subplot
...
# FRO: Added the following line to remove the need to press a key
#plt.pause(0.1)
fig.savefig("../figures/creation-time.pdf", dpi = 400, format="pdf")
# %%
